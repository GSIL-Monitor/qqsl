...
public class SceneServiceTest extends BaseTest {
    ...
    public void testSave(){
        PanoramaConfig panoramaConfig = read();
        if(panoramaConfig.getScenes()==null){
            ...
            scene.setPanoramaConfig(panoramaConfig);
