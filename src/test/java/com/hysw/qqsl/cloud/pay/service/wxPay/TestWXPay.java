...
public class TestWXPay {
    ...
    private WXPay wxpay;
    private com.hysw.qqsl.cloud.pay.service.wxPay.WXPayConfigImpl config;
    private String out_trade_no;
    private String total_fee;

    public TestWXPay() throws Exception {
        config = com.hysw.qqsl.cloud.pay.service.wxPay.WXPayConfigImpl.getInstance();
        wxpay = new WXPay(config);
        total_fee = "1";
        // out_trade_no = "201701017496748980290321";
        out_trade_no = "201613091059590000003433-asd014";
    }
    ...
    public void doH5zhifu(){
        ...
        data.put("notify_url", "http://5007c0d2.nat123.cc/qqsl/weChat/notice");
        data.put("trade_type", "MWEB");
        JSONObject jsonObject = new JSONObject();
        jsonObject.put("type", "Wap");
        jsonObject.put("wap_url", "www.qingqingshuili.com");
        jsonObject.put("wap_name", "青清水利在线服务");
        JSONObject jsonObject1 = new JSONObject();
        jsonObject1.put("h5_info", jsonObject);
        data.put("scene_info", jsonObject1.toString());
...
//        data.put("transaction_id", "4008852001201608221962061594");
    ...
    public void doGetSandboxSignKey() throws Exception {
        com.hysw.qqsl.cloud.pay.service.wxPay.WXPayConfigImpl config = WXPayConfigImpl.getInstance();
        HashMap<String, String> data = new HashMap<String, String>();
