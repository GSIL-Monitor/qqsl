...
import com.hysw.qqsl.cloud.entity.Verification;
...
public class AdminController {
    ...
    public @ResponseBody Message addAccount(@RequestBody  Map<String,Object> object){
        Message message = Message.parameterCheck(object);
        if(message.getType()== Message.Type.FAIL){
            return message;
        }
        return adminService.addDiffConnPoll(object);
    }
    ...
    public @ResponseBody Message deleteAccount(@PathVariable("id") Long id){
        return adminService.deteleDiffConnPoll(id);
    }
    ...
    public @ResponseBody Message accountList(){
        return adminService.accountList();
    }

//    @RequestMapping(value = "/editAccount",method = RequestMethod.POST)
//    @RequiresRoles(value = {"admin"}, logical = Logical.OR)
//    public @ResponseBody Message editAccount(@RequestBody  Map<String,Object> object) {
//        Message message = Message.parameterCheck(object);
//        if (message.getType() == Message.Type.FAIL) {
//            return message;
//        }
...
//        }
//        return adminService.editAccount(object);
//    }
}
