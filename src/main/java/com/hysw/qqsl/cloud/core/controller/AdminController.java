...
//    }
    ...
    @RequiresAuthentication
    @RequiresRoles(value = {"admin:simple"}, logical = Logical.OR)
    @RequestMapping(value = "/panorama/admin/lists", method = RequestMethod.GET)
    public
    @ResponseBody
    Message panoramaLists(@RequestBody Map<String,Object> map) {
    ...
    @RequiresAuthentication
    @RequiresRoles(value = {"admin:simple"}, logical = Logical.OR)
    @RequestMapping(value = "/panorama/admin/review/success", method = RequestMethod.POST)
    public
    @ResponseBody
    ...
    @RequiresAuthentication
    @RequiresRoles(value = {"admin:simple"}, logical = Logical.OR)
    @RequestMapping(value = "/panorama/admin/review/fail", method = RequestMethod.POST)
    public
    @ResponseBody
